...
@st.cache_data
def load_data():
    df = pd.read_csv(r"D:\Ma work\project\wangchanberta-app-ner\data\articles_processed.csv", encoding="utf-8-sig")
...
#หลังจากรันข้อมูลแล้วให้พิมพ์ "streamlit run 03_dashboard.py" บนช่อง terminal เพื่อเปิด dashboard